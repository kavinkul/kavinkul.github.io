    ...
    if (chosenValues) {
      ...
      if (stepToSave === riverHistory.length) {
        ...
        if (
          ...
          const updatedRiverHistory = [...riverHistory.slice(0, stepToSave)];
          setCurrentHistoryIndex(currentHistoryIndex - 1);
          setRiverHistory(updatedRiverHistory);
          return;
        }
        ...
        const currentDirection = findMovementDirection(
          [...riverHistory.slice(0, stepToSave), [startList, finishList]],
          stepToSave
        );
      ...
      <div className="flexContainer">
        <div className="generalUI noTextHighlight">
          ...
          <div ref={divStartListEl}>
            <Option
              selected={
                selectedStartIndex !== -1 && chosenValues[selectedStartIndex]
              }
          ...
          <div ref={divFinishListEl}>
            <Option
              selected={
                selectedFinishIndex !== -1 && chosenValues[selectedFinishIndex]
              }
